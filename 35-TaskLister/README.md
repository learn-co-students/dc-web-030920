...
Goal of THIS Lab Review:
- less about how to build the features
- more about how to approach the problem
...
- As a user, the task string that I provided should appear on the DOM WHEN the submit button has been activated.
